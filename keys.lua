...
function M.apply_to_config(config)
  local tab_close_action = platform.is_windows
      and act.CloseCurrentTab { confirm = true }
  ...
  config.keys = {
    ...
    { key = 'v', mods = platform.direct_mods, action = act.SplitPane { direction = 'Right', size = { Percent = 50 } } },
    { key = 's', mods = platform.direct_mods, action = act.SplitPane { direction = 'Down', size = { Percent = 50 } } },

    { key = 'h', mods = platform.direct_mods, action = act.ActivatePaneDirection 'Left' },
    { key = 'j', mods = platform.direct_mods, action = act.ActivatePaneDirection 'Down' },
    { key = 'k', mods = platform.direct_mods, action = act.ActivatePaneDirection 'Up' },
    { key = 'l', mods = platform.direct_mods, action = act.ActivatePaneDirection 'Right' },
    ...
    { key = 'h', mods = primary_shift_mods, action = act.ActivateTabRelative(-1) },
    { key = 'l', mods = primary_shift_mods, action = act.ActivateTabRelative(1) },

    -- Reorder the current tab with the keyboard.
    { key = 'h', mods = move_tab_mods, action = act.MoveTabRelative(-1) },
    { key = 'l', mods = move_tab_mods, action = act.MoveTabRelative(1) },
  }
